...
class StartPage:
    ...
    def setup_ui(self):
        """
        Создание и размещение элементов интерфейса на стартовой странице.
        """
    ...
    def setup_settings(self):
        """
        Сохранение выбранных настроек и закрытие окна.

        Устанавливается выбранный режим игры и уровень сложности.
        Закрывается окно после сохранения настроек.
        """
